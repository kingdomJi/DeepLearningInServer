...
dir_img = Path(r'..\data\data_Chen_new\augmentation_Jiang\patches\publicAndkq6ForAdapt\kq6_448\\')
...
dir_mask = Path(r'..\data\data_Chen_new\augmentation_Jiang\patches\publicAndkq6ForAdapt\kq6_mask_448\\')
...
checkpoint_Path='../checkpoints/TransUnet/freezeEncoder_pretrain=PublicTrainbykq6_448_L2=1e-6/'
...
def get_args():#传入参数
    ...
    parser.add_argument('--load', '-f', type=str, default='../checkpoints/TransUnet/Public_size=448_optim=RMSprop_L2=1e-6/checkpoint_epoch77.pth')#加载已经训练过的模型
