...
def get_args():
    ...
    parser.add_argument('--model', '-m', default=r'checkpoints/TransUnet/freezeEncoder_pretrain=PublicTrainbykq6_448_L2=1e-6/checkpoint_epoch54.pth', metavar='FILE',
    #parser.add_argument('--model', '-m',default='./checkpoints_UNet_Chen_Unenhance_e40/checkpoint_epoch40.pth',metavar='FILE',
                        #'checkpoints/TransUnet/freezeEncoder_pretrain=PublicTrainbykq6_448_L2=1e-6/checkpoint_epoch2.pth'
                        #checkpoints/TransUnet/freezeEncoder_NTPublicToWJSE33Trainbykq6_L2=1e-6/checkpoint_epoch79.pth
